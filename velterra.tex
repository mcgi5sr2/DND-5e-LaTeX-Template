...
- Make a input file for "misc characters" and just have a title pic and short summary for each of the secondary characters, all running into eachother rather than one page each. 
- Velterra world section - key locations.  Backstory of the Gods (put the list of gods in a sidebox thing)
- add in mike's classes as appendices 
...
\vspace*{-15mm}
\hspace*{-117mm}
\includegraphics{./img/mockCover.pdf}
...
\input{content/eps/335a.tex}
\input{content/eps/335b.tex}
\input{content/eps/335c.tex}
\input{content/eps/335d.tex}
